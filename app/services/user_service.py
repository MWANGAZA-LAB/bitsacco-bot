...
class UserService:
    ...
    def __init__(self, bitsacco_api: BitsaccoAPIService):
    ...
    async def update_session(self, session: UserSession) -> None:
        ...
        logger.debug("Updated user session", 
...
_The code expires in 5 minutes_
            ...
            logger.error("Error starting authentication", 
                        user=phone_number, error=str(e))
        ...
        try:
            ...
            if session.otp_sent_at:
                ...
                if otp_age > self.otp_timeout:
                    ...
                    await self.update_session(session)
                    return False, "❌ Verification code expired. Type 'start' to get a new code."
