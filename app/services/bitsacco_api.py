...
class BitsaccoAPIClient:
    ...
    async def get_user_by_phone(self, phone_number: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if e.response.status_code == 404:
                ...
                logger.error("Error fetching user by phone", error=str(e), phone=phone_number)
                raise
        
        except Exception as e:
            logger.error("Unexpected error fetching user", error=str(e), phone=phone_number)
            raise
    ...
    async def verify_otp(self, phone_number: str, otp_code: str) -> Dict[str, Any]:
        ...
        try:
            ...
            response = await self._make_request("POST", "/auth/verify-otp", json=payload)
    ...
    async def initiate_bitcoin_savings(self, phone_number: str, amount_kes: float) -> Dict[str, Any]:
        ...
        try:
            ...
            response = await self._make_request("POST", "/transactions/savings/initiate", json=payload)
            ...
            logger.error("Error initiating Bitcoin savings", error=str(e), 
                        phone=phone_number, amount=amount_kes)
            return {"success": False, "message": f"Error: {str(e)}"}
    
    async def get_transaction_history(self, user_id: str, limit: int = 10, offset: int = 0) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error("Error fetching transaction history", error=str(e), user_id=user_id)
            return {"success": False, "message": f"Error: {str(e)}"}
    ...
    async def get_transaction_status(self, transaction_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error("Error fetching transaction status", error=str(e), 
                        transaction_id=transaction_id)
            return {"success": False, "message": f"Error: {str(e)}"}
    ...
    async def _make_request(
        ...
        for attempt in range(self.max_retries + 1):
            try:
                ...
                logger.error("Unexpected error in API request", error=str(e), endpoint=endpoint)
                raise
