...
class Settings(BaseSettings):
    ...
    # Bitsacco API
    BITSACCO_API_URL: str = Field(
        default="https://api.bitsacco.com", env="BITSACCO_API_URL"
    )
    BITSACCO_API_KEY: str = Field(
        default="dev-api-key-change-in-production", env="BITSACCO_API_KEY"
    )
